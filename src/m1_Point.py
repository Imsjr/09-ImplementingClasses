...
class Point(object):
    ...
    def move_to(self,x,y):
        ...
        self.accumulate = math.sqrt(((self.startx-self.x)**2)+(self.starty-self.y)**2)
        return Point(self.x,self.y)
    ...
    def move_by(self,x,y):
        ...
        self.x = self.x + x
        self.y = self.y + y
        self.accumulate = math.sqrt(((self.x-self.startx)**2)+(self.y-self.starty)**2)
        return Point(self.x,self.y)
    ...
    def get_distance_from(self,point2):
        self.distance = math.sqrt(((self.x-point2.x)**2)+(self.y-point2.y)**2)
    ...
    def closer_to(self,p1,p2):
        self.d1 = math.sqrt(((self.x-p1.x)**2)+(self.y-p1.y)**2)
        self.d2 = math.sqrt(((self.x-p2.x)**2)+(self.y-p2.y)**2)
        if self.d1>=self.d2:
            return p2
        if self.d1<self.d2:
            return p1
